...
# ==========================================================
# CIC: 通用平均-尺度超先驗模型 (Universal Mean-Scale Hyperprior)
# ==========================================================
class CIC(nn.Module):
    """
...
def build_model(model_name, **kwargs):
    """
    Factory function to create CIC models with specific configurations.
    
    Presets:
    - 'cic': N=128, M=192 (Teacher Standard)
    - 'cic_student': N=64, M=192 (Student Standard)
    - 'cic_tiny': N=32, M=192 (Edge/Mobile)
    
    You can override N or M by passing them as kwargs.
    Example: build_model("cic_tiny", M=320)
    """
    # 預設配置表
    configs = {
        "cic":         {"N": 128, "M": 192},
        "cic_student": {"N": 64,  "M": 192},
        "cic_tiny":    {"N": 32,  "M": 192},
    }
    ...
    return CIC(N=params["N"], M=params["M"])