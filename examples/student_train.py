...
# ==========================================================
# 修改點 1: 引入我們剛寫好的 build_model (取代原本的 import TIC, TIC_Student)
# ==========================================================
...
def parse_args(argv):
    parser = argparse.ArgumentParser(description="TIC Student Distillation Training")
    
    # ==========================================================
    # 修改點 2: 新增 Teacher/Student 架構控制參數
    # ==========================================================
    parser.add_argument("--teacher-model", type=str, default="tic", help="Teacher model architecture name")
    parser.add_argument("--teacher-n", type=int, default=128, help="Teacher hidden channels N (e.g., 128 or 64)")
    
    parser.add_argument("--student-model", type=str, default="tic_student", help="Student model architecture name")
    parser.add_argument("--student-n", type=int, default=64, help="Student hidden channels N (e.g., 64 or 32)")
    
    parser.add_argument("--m", type=int, default=192, help="Latent channels M (Shared between Teacher/Student)")
    # ==========================================================
    ...
    parser.add_argument("-lr", "--learning-rate", default=1e-4, type=float, help="Learning rate (default: 1e-4 )")
    ...
    parser.add_argument("--patch-size", type=int, nargs=2, default=(256, 256), help="Patch size (default: 256x256)")
...
def main(argv):
    ...
    wandb.init(project="tic-student-distillation", name=args.name, config=vars(args))
    ...
    # =========================================================
    # 修改點 3: 初始化 Teacher 模型 (使用 build_model + 參數控制)
    # =========================================================
    ...
    # =========================================================
    # 修改點 4: 初始化 Student 模型 (使用 build_model + 參數控制)
    # =========================================================
    ...
    for epoch in range(last_epoch, args.epochs):
        ...
        # 評估只看 Student 自己的 MSE Loss (或 PSNR)
