...
int main(int argc, char** argv) {
    try {
        ...
        const std::string MODEL_ENCODER        = "./model/onnx/tic_encoder.onnx";
        const std::string MODEL_HYPER_DECODER  = "./model/onnx/tic_hyper_decoder.onnx";
